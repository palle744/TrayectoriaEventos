<script>
    $(document).ready(function() {
        ...
        TablaEventos = $("#busquedaTable").DataTable({
            ...
            dom: 'lBfrtip',
            stateSave: true,
            ajax: '<?php echo base_url(); ?>index.php/busqueda_control/cargarIngresos',
            language: {
            ...
            buttons: {
                ...
                buttons: [{
                    ...
                    title: function() {
                        ...
                        return 'Asistencias a EventosGTO - Búsqueda: ' + searchValue + ' - Generado el ' + currentDate;
                    },
                    ...
                    title: function() {
                        var searchValue = $('#busquedaTable_filter input').val();
                        return 'Asistencias a EventosGTO - Búsqueda: ' + searchValue;
                    },
